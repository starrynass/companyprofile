...
<!-- MAIN CONTAINER DENGAN GLOW ORB -->
<div class="position-relative bg-slate-50 overflow-hidden py-5">
    ...
    <div class="container position-relative py-3" style="z-index: 1;">
        ...
        @if($artikels->count() > 0)
                    ...
                    <div class="col-lg-5">
                        <div class="card-body p-4 p-lg-5 d-flex flex-column justify-content-center">
                            <div class="d-flex align-items-center text-muted small mb-2 gap-2">
                                <span><i class="fa-regular fa-calendar-days text-indigo me-1"></i> {{ \Carbon\Carbon::parse($featured->tanggal)->format('d M Y') }}</span>
                            </div>
            ...
            <!-- 2. GRID ARTIKEL LAINNYA -->
            <div class="row g-4">
                @foreach($artikels->skip(1) as $artikel)
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 100 }}">
                        <!-- Tambahkan kelas custom card-article-item untuk efek hover card keseluruhan -->
                        <div class="card bg-white rounded-4 border-0 shadow-sm h-100 hover-lift overflow-hidden d-flex flex-column card-article-item">
                            ...
                            <!-- Thumbnail Minimalis dengan Zoom Effect -->
                            ...
                            <div class="card-body p-4 d-flex flex-column flex-grow-1">
                                ...
                                <!-- Tombol Aksi Minimalis (Perbaikan Center Flexbox & Icon Transition) -->
        ...
        @else
            ...
            <div class="col-12 text-center py-5" data-aos="fade-up">
                <div class="p-5 bg-white rounded-4 border shadow-sm d-inline-block">
                    ...
                    <p class="text-muted mb-0">Silakan tambahkan data artikel melalui database atau admin panel nantinya.</p>
                </div>
            </div>
        @endif
...
<!-- Tambahan Style CSS Interaktif untuk Hover & Perataan Ikon -->
<style>
    /* Memastikan ikon benar-benar di tengah secara vertikal & horizontal */
    .action-arrow-btn {
    ...
    /* Animasi Hover Card & Tombol Panah */
    .card-article-item:hover {
        transform: translateY(-5px);
        box-shadow: 0 1rem 3rem rgba(99, 102, 241, 0.12) !important;
    }

    .card-article-item:hover .action-arrow-btn {
    ...
    .card-article-item:hover .article-title-link {
        color: #6366f1 !important;
        transition: color 0.2s ease;
    }

    /* Efek Zoom Gambar saat Card Disorot */
    .card-article-item:hover .hover-zoom {
