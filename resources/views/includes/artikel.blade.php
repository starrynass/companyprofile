...
<section class="position-relative text-white py-5 d-flex align-items-center"
    ...
    <div class="container py-5 text-center position-relative mb-4" style="z-index: 2;" data-aos="fade-down">
        ...
        <h1 class="fw-bold text-white mb-3 fs-2 fs-md-1" style="text-shadow: 0 3px 8px rgba(0,0,0,0.7);">
            Artikel & Wawasan IT
        </h1>
        <p class="lead text-light mx-auto small fs-md-6" style="max-width: 700px; text-shadow: 0 2px 5px rgba(0,0,0,0.7);">
        ...
        @if($artikels->count() > 0)
            ...
            <div class="card bg-white border-0 rounded-4 shadow-sm mb-5 overflow-hidden hover-lift" data-aos="fade-up">
                <div class="row g-0 align-items-center">
                    <div class="col-lg-7 position-relative overflow-hidden" style="min-height: 250px;">
                        ...
                        <span class="badge bg-indigo text-white position-absolute top-0 start-0 m-3 px-3 py-2 rounded-pill shadow">
                            <i class="fa-solid fa-star me-1"></i> Artikel Utama
                        </span>
                    </div>
                    <div class="col-lg-5">
                        <div class="card-body p-3 p-sm-4 p-lg-5 d-flex flex-column justify-content-center">
                            ...
                            <h3 class="fw-bold text-dark mb-3 fs-4 fs-lg-3">
                                {{ $featured->judul }}
                            </h3>
            ...
            <div class="d-flex flex-column flex-sm-row align-items-start align-items-sm-center justify-content-between gap-2 mb-4 mt-5" data-aos="fade-up">
                <h4 class="fw-bold text-dark m-0 fs-5 fs-sm-4"><i class="fa-solid fa-list-ul text-indigo me-2"></i> Artikel Lainnya</h4>
                ...
                @foreach($artikels->skip(1) as $artikel)
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 100 }}">
                        <div class="card bg-white rounded-4 border-0 shadow-sm h-100 hover-lift overflow-hidden d-flex flex-column card-article-item">
                            ...
                            <div class="card-body p-3 p-sm-4 d-flex flex-column flex-grow-1">
